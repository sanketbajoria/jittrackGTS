...
jittrackgtsApp.controller('MainController', function ($scope) {
    });

jittrackgtsApp.controller('AdminController', function ($scope) {
    });

jittrackgtsApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
jittrackgtsApp.controller('MenuController', function ($scope) {
    });

jittrackgtsApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
jittrackgtsApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

jittrackgtsApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
jittrackgtsApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
jittrackgtsApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
jittrackgtsApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
jittrackgtsApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 jittrackgtsApp.controller('TrackerController', ['AccessToken'], function ($scope, AccessToken) {
...
jittrackgtsApp.controller('HealthController', function ($scope, HealthCheckService) {
...
jittrackgtsApp.controller('ConfigurationController', function ($scope, resolvedConfiguration) {
    $scope.configuration = resolvedConfiguration;
});

jittrackgtsApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
jittrackgtsApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
jittrackgtsApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
