...
var jittrackgtsApp = angular.module('jittrackgtsApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'jittrackgtsAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
